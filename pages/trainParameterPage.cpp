...
TrainParameterWidget::TrainParameterWidget(QWidget *parent)
    ...
    labels = {
        "Inertial Coefficient Trailer", "Number of Axle",
        "Inertial Coefficient Motor", "Number of Traction Motor",
        "Wheel Diameter (mm)", "Passenger Weight (kg)",
        "Gear Ratio", "Load per Car (ton)"
    };
