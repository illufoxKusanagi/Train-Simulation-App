...
static constexpr auto qt_meta_stringdata_ZN13InputDropdownE = QtMocHelpers::stringData(
    "InputDropdown",
    "valueChanged",
    ""
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN13InputDropdownE[] = {
...
Q_CONSTINIT const QMetaObject InputDropdown::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN13InputDropdownE.offsetsAndSizes,
    qt_meta_data_ZN13InputDropdownE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN13InputDropdownE_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<InputDropdown, std::true_type>,
        // method 'valueChanged'
...
void InputDropdown::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (InputDropdown::*)();
            if (_q_method_type _q_method = &InputDropdown::valueChanged; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
void *InputDropdown::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN13InputDropdownE.stringdata0))
