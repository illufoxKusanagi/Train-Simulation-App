...
static constexpr auto qt_meta_stringdata_ZN9LeftPanelE = QtMocHelpers::stringData(
    "LeftPanel",
    "navigateToPage",
    "",
    "pageIndex",
...
Q_CONSTINIT static const uint qt_meta_data_ZN9LeftPanelE[] = {
...
Q_CONSTINIT const QMetaObject LeftPanel::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN9LeftPanelE.offsetsAndSizes,
    qt_meta_data_ZN9LeftPanelE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN9LeftPanelE_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<LeftPanel, std::true_type>,
        // method 'navigateToPage'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        QtPrivate::TypeAndForceComplete<int, std::false_type>,
        // method 'emitNavigateSignal'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        QtPrivate::TypeAndForceComplete<int, std::false_type>
    >,
    nullptr
...
void LeftPanel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (LeftPanel::*)(int );
            if (_q_method_type _q_method = &LeftPanel::navigateToPage; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
void *LeftPanel::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN9LeftPanelE.stringdata0))
