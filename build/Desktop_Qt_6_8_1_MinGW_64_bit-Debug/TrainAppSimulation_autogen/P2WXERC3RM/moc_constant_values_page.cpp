...
static constexpr auto qt_meta_stringdata_ZN18ConstantValuesPageE = QtMocHelpers::stringData(
    "ConstantValuesPage"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN18ConstantValuesPageE[] = {
...
Q_CONSTINIT const QMetaObject ConstantValuesPage::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN18ConstantValuesPageE.offsetsAndSizes,
    qt_meta_data_ZN18ConstantValuesPageE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN18ConstantValuesPageE_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<ConstantValuesPage, std::true_type>
    >,
    nullptr
} };
...
void *ConstantValuesPage::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN18ConstantValuesPageE.stringdata0))
