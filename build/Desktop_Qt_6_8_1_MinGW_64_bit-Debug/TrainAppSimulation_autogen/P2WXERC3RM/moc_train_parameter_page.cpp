...
static constexpr auto qt_meta_stringdata_ZN18TrainParameterPageE = QtMocHelpers::stringData(
    "TrainParameterPage",
    "awDataChanged",
    ""
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN18TrainParameterPageE[] = {
...
Q_CONSTINIT const QMetaObject TrainParameterPage::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN18TrainParameterPageE.offsetsAndSizes,
    qt_meta_data_ZN18TrainParameterPageE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN18TrainParameterPageE_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<TrainParameterPage, std::true_type>,
        // method 'awDataChanged'
...
void TrainParameterPage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (TrainParameterPage::*)();
            if (_q_method_type _q_method = &TrainParameterPage::awDataChanged; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
void *TrainParameterPage::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN18TrainParameterPageE.stringdata0))
