...
template <> constexpr inline auto TractionEffortPage::qt_create_metaobjectdata<qt_meta_tag_ZN18TractionEffortPageE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<TractionEffortPage, qt_meta_tag_ZN18TractionEffortPageE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject TractionEffortPage::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN18TractionEffortPageE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN18TractionEffortPageE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN18TractionEffortPageE_t>.metaTypes,
    nullptr
} };
...
void *TractionEffortPage::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN18TractionEffortPageE_t>.strings))
